      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7">
            I began studying Systems Engineering while working local jobs in technical informatic. Now, after taking four exceptional courses of over 1200 hours, i gained the experience in working in the following technologies:
          </p>
        </motion.div>
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          <div className="relative h-32">
            <div className="z-10">
              <p className="font-playfair font-semibold text-5xl">Responsive</p>
          ...
          <p className="mt-5">
            HTML for content, and CSS for design.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-5">
            Node.js, Express framework, MongoDB and the Mongoose library.
          </p>
        </motion.div>
      </div>
    </section>
